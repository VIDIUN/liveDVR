...
git clone https://github.com/vidiun/nginx-secure-token-module

echo "pulling nginx-vod-module"
git clone https://github.com/vidiun/nginx-vod-module

echo "pulling nginx_requestid"
git clone https://github.com/vidiun/nginx_requestid
...
git clone https://github.com/vidiun/nginx_mod_akamai_g2o
