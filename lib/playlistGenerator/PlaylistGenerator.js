 ...
 *   for details see https://github.com/vidiun/nginx-vod-module
 * */
...
function PlaylistGenerator (entryObject, options) {
    ...
    if (_.has(options, 'recording') && options.recording == true){
        ...
        that.playListLimits =  {};
        if (entryObject.viewMode == vidiunTypes.VidiunViewMode.ALLOW_ALL)
        {
    ...
    // according to https://github.com/vidiun/nginx-vod-module
