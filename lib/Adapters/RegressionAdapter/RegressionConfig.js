...
/*------------------------------------------------------------------------------
 ...
 | node lib/App.js run_regression url=http://localhost:8080/vLive/smil:1_oorxcge2_all.smil/1/chunklist.m3u8 entry_path="1_oorxcge2\ 1"
 ...
 --------------------------------------------------------------------------------
 |  url=http://localhost:8080/vLive/smil:1_oorxcge2_all.smil/chunklist.m3u8
 --------------------------------------------------------------------------------
 | example url to test specific flavor (flavor id 1):
 --------------------------------------------------------------------------------
 | url : http://localhost:8080/vLive/smil:1_oorxcge2_all.smil/1/chunklist.m3u8
 --------------------------------------------------------------------------------
 ...
 | record url=http://localhost:8080/vLive/smil:1_oorxcge2_all.smil/chunklist.m3u8 -duration=10 -override=true -path=demo_1
