...
var vidiunTypes = require('./../vidiun-client-lib/VidiunTypes');
var vidiunVO = require('./../vidiun-client-lib/VidiunVO');
var config = require('../../common/Configuration');
var VidiunLiveStatus = require('../vidiun-client-lib/VidiunTypes').VidiunEntryServerNodeStatus;
    ...
    getEntryInfo : function(entryId) {
        if (realBackendClient) {
            return realBackendClient.getEntryInfo(entryId).then(function(res) {
                entryServerNodes.add(res, VidiunLiveStatus.BROADCASTING);
                return res;
            });
        }
