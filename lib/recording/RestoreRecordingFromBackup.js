...
//nvm run v6.3.0 /opt/vidiun/liveController/latest/lib/recording/RestoreRecordingFromBackup.js -p "/web/content/vLive/liveRecorder/recordings/append/n/1_y9tatu4n/UNKNOWN"
...
let status = 0;
let durationMsec = -1;
const mediaServerIndex = vidiunTypes.VidiunEntryServerNodeType.LIVE_PRIMARY;
const liveEntryStatus = vidiunTypes.VidiunEntryServerNodeStatus.PLAYABLE;
